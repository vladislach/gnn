...
class GraphDataset(Dataset):
    def __init__(self, encoded_atoms_list, edges_list, natoms_list, dGsolv_list):
        '''
    ...
    def __getitem__(self, idx):
        ...
        return encoded_atoms, edges, natoms, dGsolv
...
def collate_graphs(batch):
    ...
    for i in range(len(batch)):
        encoded_atoms, edges, natoms, dGsolv = batch[i]
    ...
    return encoded_atoms_batch, edges_batch, natoms_batch, dGsolv_batch
